...
extern "C" {
    ...
    fn PyBytes_FromFormat(fmt: *const core::ffi::c_char, ...) -> *mut crate::object::PyObject;
    fn PyBytes_FromFormatV(
        fmt: *const core::ffi::c_char,
        va: *mut core::ffi::c_void,
    ) -> *mut crate::object::PyObject;
    fn PyErr_Format(
    ...
    // RFC 0077 WS12 — 3.14 variadic entry points (varargs.c).
    fn PyUnicodeWriter_Format(
        writer: *mut crate::abi314::PyUnicodeWriter,
...
static FORCE_LINK: &[FnPtr] = &[
    ...
    addr!(numbers::PyLong_AsUnsignedLongMask),
    addr!(numbers::PyLong_AsUnsignedLongLongMask),
    ...
    addr!(containers::PyList_GetItemRef),
    ...
    addr!(lifecycle::PyThreadState_SetAsyncExc),
    ...
    // RFC 0077 WS12 — the CPython 3.14 C-API delta (abi314.rs + varargs.c).
    addr!(PyUnicodeWriter_Format),
    addr!(PySys_Audit),
    addr!(lifecycle::Py_PACK_FULL_VERSION),
    addr!(lifecycle::Py_PACK_VERSION),
    addr!(crate::abi314::PyUnicodeWriter_Create),
    addr!(crate::abi314::PyUnicodeWriter_Discard),
    addr!(crate::abi314::PyUnicodeWriter_Finish),
    addr!(crate::abi314::PyUnicodeWriter_WriteChar),
    addr!(crate::abi314::PyUnicodeWriter_WriteUTF8),
    addr!(crate::abi314::PyUnicodeWriter_WriteASCII),
    addr!(crate::abi314::PyUnicodeWriter_WriteWideChar),
    addr!(crate::abi314::PyUnicodeWriter_WriteUCS4),
    addr!(crate::abi314::PyUnicodeWriter_WriteStr),
    addr!(crate::abi314::PyUnicodeWriter_WriteRepr),
    addr!(crate::abi314::PyUnicodeWriter_WriteSubstring),
    addr!(crate::abi314::PyUnicodeWriter_DecodeUTF8Stateful),
    addr!(crate::abi314::PyLong_FromInt32),
    addr!(crate::abi314::PyLong_FromUInt32),
    addr!(crate::abi314::PyLong_FromInt64),
    addr!(crate::abi314::PyLong_FromUInt64),
    addr!(crate::abi314::PyLong_AsInt32),
    addr!(crate::abi314::PyLong_AsInt64),
    addr!(crate::abi314::PyLong_AsUInt32),
    addr!(crate::abi314::PyLong_AsUInt64),
    addr!(crate::abi314::PyLong_GetSign),
    addr!(crate::abi314::PyLong_IsPositive),
    addr!(crate::abi314::PyLong_IsNegative),
    addr!(crate::abi314::PyLong_IsZero),
    addr!(crate::abi314::PyUnstable_Long_IsCompact),
    addr!(crate::abi314::PyUnstable_Long_CompactValue),
    addr!(crate::abi314::PyLong_AsPid),
    addr!(crate::abi314::PyLong_GetNativeLayout),
    addr!(crate::abi314::PyLong_Export),
    addr!(crate::abi314::PyLong_FreeExport),
    addr!(crate::abi314::PyLongWriter_Create),
    addr!(crate::abi314::PyLongWriter_Finish),
    addr!(crate::abi314::PyLongWriter_Discard),
    addr!(crate::abi314::Py_HashBuffer),
    addr!(crate::abi314::PyBytes_Join),
    ...
    addr!(crate::abi314::Py_fopen),
    addr!(crate::abi314::Py_fclose),
    addr!(crate::abi314::PyConfig_Set),
    addr!(crate::abi314::PyUnstable_Object_IsUniqueReferencedTemporary),
    addr!(crate::abi314::PyUnstable_Object_EnableDeferredRefcount),
    addr!(crate::abi314::PyUnstable_IsImmortal),
    addr!(crate::abi314::PyUnstable_TryIncRef),
    addr!(crate::abi314::PyUnstable_EnableTryIncRef),
    addr!(crate::abi314::PyUnstable_Object_ClearWeakRefsNoCallbacks),
    addr!(crate::abi314::PyWeakref_IsDead),
    addr!(crate::abi314::PyTime_Time),
    addr!(crate::abi314::PyTime_TimeRaw),
    addr!(crate::abi314::PyTime_PerfCounter),
    addr!(crate::abi314::PyTime_PerfCounterRaw),
    addr!(crate::abi314::PyTime_MonotonicRaw),
    addr!(crate::abi314::PySys_AuditTuple),
    addr!(crate::abi314::PyCodec_NameReplaceErrors),
    addr!(crate::abi314::PyCode_GetCellvars),
    addr!(crate::abi314::PyCode_GetFreevars),
    addr!(crate::abi314::PyEval_SetTraceAllThreads),
    addr!(crate::abi314::PyThreadState_EnterTracing),
    addr!(crate::abi314::PyThreadState_LeaveTracing),
    addr!(crate::abi314::PyRefTracer_SetTracer),
    addr!(crate::abi314::PyRefTracer_GetTracer),
    addr!(crate::abi314::PyUnstable_AtExit),
    addr!(crate::abi314::PyCode_AddWatcher),
    addr!(crate::abi314::PyCode_ClearWatcher),
    addr!(crate::abi314::PyFunction_AddWatcher),
    addr!(crate::abi314::PyFunction_ClearWatcher),
    addr!(crate::abi314::PyType_AddWatcher),
    addr!(crate::abi314::PyType_ClearWatcher),
    addr!(crate::abi314::PyType_Watch),
    addr!(crate::abi314::PyType_Unwatch),
    addr!(crate::abi314::PyContext_AddWatcher),
    addr!(crate::abi314::PyContext_ClearWatcher),
    addr!(crate::abi314::_PyTuple_FromArray),
    addr!(crate::abi314::PyUnstable_Object_IsUniquelyReferenced),
    addr!(crate::abi314::Py_UniversalNewlineFgets),
    addr!(crate::abi314::Py_TYPE),
    addr!(crate::abi314::Py_SET_TYPE),
    addr!(crate::abi314::PyObject_GenericHash),
    addr!(crate::abi314::PyCriticalSection_Begin),
    addr!(crate::abi314::PyCriticalSection_BeginMutex),
    addr!(crate::abi314::PyCriticalSection_End),
    addr!(crate::abi314::PyCriticalSection2_Begin),
    addr!(crate::abi314::PyCriticalSection2_BeginMutex),
    addr!(crate::abi314::PyCriticalSection2_End),
    ...
    addr!(wave4::PyContext_CopyCurrent),
    addr!(wave4::PyContext_New),
    addr!(wave4::PyContext_Enter),
    addr!(wave4::PyContext_Exit),
    addr!(wave4::PyDescr_IsData),
    addr!(wave4::PyOS_BeforeFork),
    addr!(wave4::PyOS_AfterFork_Parent),
    addr!(wave4::PyOS_AfterFork_Child),
    addr!(wave4::PyOS_setsig),
    addr!(wave4::PyThread_get_thread_ident),
    addr!(wave4::PyOS_double_to_string),
    ...
    addr!(mypyc_tail::PyErr_GetHandledException),
    addr!(mypyc_tail::PyErr_SetHandledException),
    ...
    addr!(monitoring::_PyMonitoring_FireBranchLeftEvent),
    addr!(monitoring::_PyMonitoring_FireBranchRightEvent),
    ...
    addr!(containers::PyDict_PopString),
    addr!(containers::_PyDict_Pop),
    ...
    addr!(PyBytes_FromFormat),
    addr!(PyBytes_FromFormatV),
