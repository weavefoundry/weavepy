...
output=root/'target/performance-validation.json'
results=[]
...
for label in ['test_json','test_scope','test_frame','test_exceptions','test_generators','test_sys_settrace','test_sys_setprofile','test_gc','test_str','test_userstring']:
