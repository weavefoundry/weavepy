        ...
        // can read them back).
        {
            ...
            std::fs::write(
                ...
                crate::cpython_headers::PYCONFIG_H.unwrap_or(
                    // Windows keeps the pre-0062 stub: C builds there
                    // await the python313.dll wave (RFC 0063
                    // Non-goals — a static exe has nothing for a
                    // .pyd's PE import table to resolve against).
