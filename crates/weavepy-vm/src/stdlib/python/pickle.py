...
try:
    ...
    # CPython exposes PickleBuffer only from the C `_pickle`; WeavePy's
    # accelerator does not provide it, so define a faithful pure-Python
    # equivalent backed by `memoryview` (protocol-5 out-of-band buffers).
    class PickleBuffer:
