...
# WeavePy: also eagerly load multiprocessing.util so `mp.util.debug` resolves.
# CPython loads this transitively via multiprocessing.context; WeavePy's
# package layout does not, so we import it explicitly.
