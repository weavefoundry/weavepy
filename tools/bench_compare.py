    ...
    return {
        ...
        "environment": {
            ...
            for key in ("TZ", "LANG", "LC_ALL", "LC_TIME", "PYTHON_JIT", "PYTHON_GIL",
                        ...
                        "WEAVEPY_SCALAR_CALL_KIND", "WEAVEPY_FIELD_PREDICATE_KIND", "WEAVEPY_FIELD_READ_KIND", "WEAVEPY_CONDITIONAL_FIELD_KIND", "WEAVEPY_FIELD_ARGUMENT_KIND", "WEAVEPY_FIELD_ARGUMENT_FALLBACK")
        },
    }
