...
/* WeavePy: vendored verbatim from CPython 3.13 Modules/_testbuffer.c
   (RFC 0066 WS1). Deviations from upstream are single lines marked
   with `WeavePy:` comments — header shims only, no semantic edits. */
